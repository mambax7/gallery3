            ...
            switch ($tag) {
                case '0112':    // Orientation
                    ...
                    switch ($data) {
                        ...
                        case 1:
                            $data = (string)t('1: Normal (0 deg)');
                            break;
                        case 2:
                            $data = (string)t('2: Mirrored');
                            break;
                        case 3:
                            $data = (string)t('3: Upside-down');
                            break;
                        case 4:
                            $data = (string)t('4: Upside-down Mirrored');
                            break;
                        case 5:
                            $data = (string)t('5: 90 deg CW Mirrored');
                            break;
                        case 6:
                            $data = (string)t('6: 90 deg CCW');
                            break;
                        case 7:
                            $data = (string)t('7: 90 deg CCW Mirrored');
                            break;
                        case 8:
                            $data = (string)t('8: 90 deg CW');
                            break;
                        default:
                            $data = sprintf((string)t('%d: Unknown'), $data);
                            break;
                    }
                    break;
                ...
                case '0128':    // ThumbnailResolutionUnit
                    switch ($data) {
                        case 1:
                            $data = (string)t('No Unit');
                            break;
                        case 2:
                            $data = (string)t('Inch');
                            break;
                        case 3:
                            $data = (string)t('Centimeter');
                            break;
                    }
                    break;
                case '0213':    // YCbCrPositioning
                    switch ($data) {
                        case 1:
                            $data = (string)t('Center of Pixel Array');
                            break;
                        case 2:
                            $data = (string)t('Datum Point');
                            break;
                    }
                    break;
                case '8822':    // ExposureProgram
                    switch ($data) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            $data = (string)t('Program Creative');
                            break;
                        case 6:
                            $data = (string)t('Program Action');
                            break;
                        case 7:
                ...
                case '9207':    // MeteringMode
                    switch ($data) {
                        case 1:
                            $data = (string)t('Average');
                            break;
                        case 2:
                            $data = (string)t('Center Weighted Average');
                            break;
                        case 3:
                            $data = (string)t('Spot');
                            break;
                        case 4:
                            $data = (string)t('Multi-Spot');
                            break;
                        case 5:
                            $data = (string)t('Pattern');
                            break;
                        case 6:
                            $data = (string)t('Partial');
                            break;
                        case 255:
                            $data = (string)t('Other');
                            break;
                ...
                case '9208':    // LightSource
                    switch ($data) {
                        case 1:
                            ...
                            break;
                        case 2:
                            $data = (string)t('Fluorescent');
                            break;
                        case 3:
                            $data = (string)t('Tungsten');
                        ...
                        // 10 Flash
                        case 17:
                            $data = (string)t('Standard Light A');
                            break;
                        case 18:
                            $data = (string)t('Standard Light B');
                            break;
                        case 19:
                            $data = (string)t('Standard Light C');
                            break;
                        case 20:
                            $data = (string)t('D55');
                            break;
                        ...
                        case 23:
                            ...
                            break;
                        case 24:
                            $data = (string)t('ISO Studio Tungsten');
                            break;
                        case 255:
                            $data = (string)t('Other');
                            break;
                ...
                case '9209':    // Flash
                    switch ($data) {
                        case 0:
                            $data = (string)t('No Flash');
                            break;
                        case 1:
                            $data = (string)t('Flash');
                            break;
                        case 5:
                            $data = (string)t('Flash, strobe return light not detected');
                            break;
                        case 7:
                            $data = (string)t('Flash, strobe return light detected');
                            break;
                        case 9:
                            $data = (string)t('Compulsory Flash');
                            break;
                        case 13:
                            $data = (string)t('Compulsory Flash, Return light not detected');
                            break;
                        case 15:
                            $data = (string)t('Compulsory Flash, Return light detected');
                            break;
                        case 16:
                            $data = (string)t('No Flash');
                            break;
                        case 24:
                            ...
                            break;
                        case 25:
                            $data = (string)t('Flash, Auto-Mode');
                            break;
                        case 29:
                            $data = (string)t('Flash, Auto-Mode, Return light not detected');
                            break;
                        case 31:
                            $data = (string)t('Flash, Auto-Mode, Return light detected');
                            break;
                        case 32:
                            $data = (string)t('No Flash');
                            break;
                        case 65:
                            $data = (string)t('Red Eye');
                            break;
                        case 69:
                            $data = (string)t('Red Eye, Return light not detected');
                            break;
                        case 71:
                            $data = (string)t('Red Eye, Return light detected');
                            break;
                        case 73:
                            $data = (string)t('Red Eye, Compulsory Flash');
                            break;
                        case 77:
                            $data = (string)t('Red Eye, Compulsory Flash, Return light not detected');
                            break;
                        case 79:
                            $data = (string)t('Red Eye, Compulsory Flash, Return light detected');
                            break;
                        case 89:
                            $data = (string)t('Red Eye, Auto-Mode');
                            break;
                        case 93:
                            $data = (string)t('Red Eye, Auto-Mode, Return light not detected');
                            break;
                        case 95:
                            $data = (string)t('Red Eye, Auto-Mode, Return light detected');
                            break;
                        default:
                            $data = (string)t('Unknown') . ': ' . $data;
                            break;
                ...
                case '0103':    // Compression
                    switch ($data) {
                        case 1:
                            $data = (string)t('No Compression');
                            break;
                        case 6:
                            $data = (string)t('Jpeg Compression');
                            break;
                        default:
                            $data = (string)t('Unknown') . ': ' . $data;
                            break;
                ...
                case 'a217':    // SensingMethod
                    switch ($data) {
                        case 1:
                            $data = (string)t('Not defined');
                            break;
                        case 2:
                            $data = (string)t('One Chip Color Area Sensor');
                            break;
                        case 3:
                            $data = (string)t('Two Chip Color Area Sensor');
                            break;
                        case 4:
                            $data = (string)t('Three Chip Color Area Sensor');
                            break;
                        case 5:
                            $data = (string)t('Color Sequential Area Sensor');
                            break;
                        case 7:
                            $data = (string)t('Trilinear Sensor');
                            break;
                        case 8:
                            $data = (string)t('Color Sequential Linear Sensor');
                            break;
                        default:
                            $data = (string)t('Unknown') . ': ' . $data;
                            break;
