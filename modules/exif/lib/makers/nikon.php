    ...
    if (0 == $model) {
        ...
        switch ($tag) {
            ...
            case '0017':
                ...
                break;
            case '0018':
                $tag = 'FlashExposureBracketValue';
                break;
            case '0019':
                $tag = 'ExposureBracketValue';
                break;
            case '001a':
                $tag = 'ImageProcessing';
                break;
            ...
            case '001f':
                ...
                break;
            case '0020':
                $tag = 'ImageAuthentication';
                break;
            case '0022':
                $tag = 'ActiveD-Lighting';
                break;
            case '0023':
                $tag = 'PictureControl';
                break;
            ...
            switch ($tag) {
                case '0003':
                    if (0 == $model) { //Quality
                        switch ($data) {
                            case 1:
                                $data = (string)t('VGA Basic');
                                break;
                            case 2:
                                $data = (string)t('VGA Normal');
                                break;
                            case 3:
                                $data = (string)t('VGA Fine');
                                break;
                            case 4:
                                $data = (string)t('SXGA Basic');
                                break;
                            case 5:
                                $data = (string)t('SXGA Normal');
                                break;
                            case 6:
                                $data = (string)t('SXGA Fine');
                                break;
                            default:
                    ...
                    if (0 == $model) { //Image Adjustment
                        switch ($data) {
                            case 0:
                                ...
                                break;
                            case 1:
                                $data = (string)t('Bright+');
                                break;
                            case 2:
                                $data = (string)t('Bright-');
                                break;
                            case 3:
                                $data = (string)t('Contrast+');
                                break;
                            case 4:
                                $data = (string)t('Contrast-');
                                break;
                    ...
                    if (0 == $model) { //White Balance
                        switch ($data) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                $data = (string)t('Fluorescence');
                                break;
                            case 5:
                                $data = (string)t('Cloudy');
                                break;
                            case 6:
                                $data = (string)t('SpeedLight');
                                break;
                            default:
                                $data = (string)t('Unknown') . ': ' . $data;
                                break;
