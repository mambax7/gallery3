...
<div id="g-movies-admin" class="g-block ui-helper-clearfix">
    ...
    <p>
        ...
        <?= t('To use FFmpeg without fully installing it, download a pre-compiled, <b>static build</b> of FFmpeg from one of the links <a href="%url">here</a>.', ['url' => 'http://ffmpeg.org/download.html']) ?>
    ...
    <p>
        <?= t("Can't get FFmpeg configured on your system? <a href=\"%url\">We can help!</a>", ['url' => 'http://codex.galleryproject.org/Gallery3:FAQ#Why_does_it_say_I.27m_missing_ffmpeg.3F']) ?>
    </p>
    ...
    <div class="g-available">
        ...
        <div id="g-ffmpeg" class="g-block">
            ...
            <p>
                ...
                <?= t('Please refer to the <a href="%url">FFmpeg website</a> for more information.', ['url' => 'http://ffmpeg.org']) ?>
            </p>
            <div class="g-module-status g-info">
                <?php if ($ffmpeg_dir): ?>
                    <?php if ($ffmpeg_version): ?>
                        <p><?= t('FFmpeg version %version was found in %dir', ['version' => $ffmpeg_version, 'dir' => $ffmpeg_dir]) ?></p>
                    <?php else: ?>
                        <p><?= t('FFmpeg (of unknown version) was found in %dir', ['dir' => $ffmpeg_dir]) ?></p>
                    <?php endif ?>
                <?php else: ?>
