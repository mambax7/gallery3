...
<ul class="g-text">
  <li>
    <?= t(
        'General Settings - choose your <a href="%graphics_url">graphics</a> and <a href="%language_url">language</a> settings.',
        [
            'graphics_url' => html::mark_clean(url::site('admin/graphics')),
  ...
  <li>
    <?= t(
        'Appearance - <a href="%theme_url">choose a theme</a>, or <a href="%theme_options_url">customize the way it looks</a>.',
        [
            'theme_url'         => html::mark_clean(url::site('admin/themes')),
  ...
  <li>
    <?= t(
        'Customize - <a href="%modules_url">install modules</a> to add cool features!',
        ['modules_url' => html::mark_clean(url::site('admin/modules'))]
                ) ?>
  </li>
</ul>
