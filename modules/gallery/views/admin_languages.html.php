            ...
            <div class="g-block-content ui-helper-clearfix">
                <form id="g-languages-form" method="post" action="<?= url::site('admin/languages/save') ?>">
                    ...
                    <table class="g-left">
                        ...
                        <?php $i = 0 ?>
                        <?php foreach ($available_locales

                        as $code => $display_name): ?>
        ...
        <div id="g-translations" class="g-block">
            ...
            <div class="g-block-content">
                ...
                <ol>
                    ...
                    <li><?= t('Make sure you have selected the right target language (currently %default_locale).', ['default_locale' => locales::display_name()]) ?></li>
