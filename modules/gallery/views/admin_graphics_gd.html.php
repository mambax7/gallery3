...
<div id="gd" class="g-block<?= $is_active ? ' g-selected' : '' ?><?= $tk->installed ? ' g-installed-toolkit' : ' g-unavailable' ?>">
    ...
    <h3> <?= t('GD') ?> </h3>
    <p>
        <?= t('The GD graphics library is an extension to PHP commonly installed most webservers.  Please refer to the <a href="%url">GD website</a> for more information.', ['url' => 'http://www.boutell.com/gd']) ?>
    </p>
