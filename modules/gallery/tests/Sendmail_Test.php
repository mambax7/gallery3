...
class Sendmail_Test extends Gallery_Unit_Test_Case
{
    ...
    public function sendmail_basic_test()
    {
        ...
        $result   = Sendmail_For_Test::factory()->to('receiver@someemail.com')->subject('Test Email Unit test')->message('The mail message body')->send()->send_text;
    ...
    {
        $expected = "To: receiver@someemail.com\r\n" . "From: from@gallery3.com\n" . "Reply-To: reply_to@gallery3.com\r\n" . "Subject: Test Email Unit test\r\n\r\n" . 'The mail message body';
        $result   = Sendmail_For_Test::factory()->to('receiver@someemail.com')->subject('Test Email Unit test')->reply_to('reply_to@gallery3.com')->message('The mail message body')->send()->send_text;
        $this->assert_equal($expected, $result);
    }
    ...
    public function sendmail_html_message_test()
    {
        ...
        $result   = Sendmail_For_Test::factory()->to('receiver@someemail.com')->subject('Test Email Unit test')->header('MIME-Version', '1.0')->header('Content-Type', 'text/html; charset=UTF-8')->message('<html><body><p>This is an html msg</p></body></html>')->send()->send_text;
        $this->assert_equal($expected, $result);
    }
    ...
    public function sendmail_wrapped_message_test()
    {
        ...
        $expected = "To: receiver@someemail.com\r\n"
                    ...
                    . 'couple of times.';
        $result   = Sendmail_For_Test::factory()->to('receiver@someemail.com')->subject('Test Email Unit test')->line_length(40)->message('This is a long message that needs to go over forty characters '
                                                                                                                                          . 'If we get lucky we might make it long enought to wrap a couple '
                                                                                                                                          . 'of times.')->send()->send_text;
        $this->assert_equal($expected, $result);
    }
}
