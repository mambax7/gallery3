...
class Legal_File_Helper_Test extends Gallery_Unit_Test_Case
{
    ...
    {
        $this->assert_equal('/website/foo.com/VID_20120513_105421.jpg', legal_file::change_extension('/website/foo.com/VID_20120513_105421', 'jpg'));
    }
    ...
    public function sanitize_filename_with_non_standard_chars_and_dots_test()
    {
        ...
        $this->assert_equal('foo.jpeg', legal_file::sanitize_filename('.foo.jpeg', 'jpg', 'photo'));
        $this->assert_equal('foo_2013_02_10.jpeg', legal_file::sanitize_filename('foo.2013/02/10.jpeg', 'jpg', 'photo'));
        $this->assert_equal('foo_bar_baz.jpg', legal_file::sanitize_filename('...foo...bar..baz...png', 'jpg', 'photo'));
        $this->assert_equal("j'écris@un#nom_bizarre(mais quand_même_ça_passe.jpg", legal_file::sanitize_filename("/j'écris@un#nom/bizarre(mais quand.même/ça_passe.\$ÇÀ@€#_", 'jpg', 'photo'));
    }
    ...
    public function sanitize_dirname_with_no_rename_test()
    {
        ...
        $this->assert_equal("j'écris@un#nom_bizarre(mais quand_même_ça_passe \$ÇÀ@€", legal_file::sanitize_dirname("j'écris@un#nom_bizarre(mais quand_même_ça_passe \$ÇÀ@€"));
    }
