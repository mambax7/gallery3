...
class Kohana_Exception extends Kohana_Exception_Core
{
     ...
     */
    /* Visible for testing*/
    public static function _sanitize_for_dump($value, $key = null, $max_level)
    {
        ...
        $sensitive_info_pattern = '/(password|pass|email|hash|private_key|session_id|session|g3sid|csrf|secret)/i';
        if (preg_match($sensitive_info_pattern, $key)
            ...
            } elseif ($value instanceof User_Model) {
