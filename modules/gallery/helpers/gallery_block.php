...
class gallery_block_Core
{
    ...
    public static function get($block_id)
    {
        ...
        switch ($block_id) {
            ...
            case 'log_entries':
                ...
                $block->content->entries = ORM::factory('log')->order_by(['timestamp' => 'DESC', 'id' => 'DESC'])->find_all(5);
                break;
    ...
    public static function get_add_block_form()
    {
        ...
        $form  = new Forge('admin/dashboard/add_block', '', 'post', ['id' => 'g-add-dashboard-block-form']);
