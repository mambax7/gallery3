...
class module_Core
{
     ...
     *                      not found
     */
    public static function info($module_name)
    {
     ...
     */
    public static function module_comparator($a, $b)
    {
     ...
     */
    public static function deactivate_missing_modules()
    {
     ...
     */
    public static function get_obsolete_modules_message()
    {
