...
class photo_Core
{
    public static function get_edit_form($photo)
    {
        ...
        $group->input('title')->label(t('Title'))->value($photo->title)->error_messages('required', t('You must provide a title'))->error_messages('length', t('Your title is too long'));
        $group->textarea('description')->label(t('Description'))->value($photo->description);
        $group->input('name')->label(t('Filename'))->value($photo->name)->error_messages('conflict', t('There is already a movie, photo or album with this name'))->error_messages('no_slashes', t("The photo name can't contain a \"/\""))->error_messages(
            'no_backslashes',
                                                                                                                                                                                                                                                            t("The photo name can't contain a \"\\\"")
        )->error_messages(
                                                                                                                                                                                                                                                                'no_trailing_period',
                                                                                                                                                                                                                                                                                                                        t("The photo name can't end in \".\"")
                                                                                                                                                                                                                                                            )->error_messages(
                                                                                                                                                                                                                                                                                                                            'illegal_data_file_extension',
                                                                                                                                                                                                                                                                                                                                                                                t('You cannot change the photo file extension')
                                                                                                                                                                                                                                                                                                                        )->error_messages(
                                                                                                                                                                                                                                                                                                                                                                                    'required',
                                                                                                                                                                                                                                                                                                                                                                                                                                                 t('You must provide a photo file name')
                                                                                                                                                                                                                                                                                                                                                                                )->error_messages(
                                                                                                                                                                                                                                                                                                                                                                                                                                                     'length',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          t('Your photo file name is too long')
                                                                                                                                                                                                                                                                                                                                                                                                                                                 );
        $group->input('slug')->label(t('Internet Address'))->value($photo->slug)->error_messages('conflict', t('There is already a movie, photo or album with this internet address'))->error_messages(
            'not_url_safe',
     ...
     */
    public static function get_file_metadata($file_path)
    {
