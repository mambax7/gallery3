...
<div class="g-block-content">
  ...
  <div>
    ...
    <p>
      <?= t2(
          'Gallery has caught %count spam for you since you installed spam filtering.', 'Gallery has caught %count spam for you since you installed spam filtering.',
          $spam_caught
) ?>
    </p>
    <?php endif ?>
    <p>
      <?php if ($counts->spam): ?>
      <?= t2(
          'There is currently one comment in your spam queue.  You can delete it with a single click, but there is no undo operation so you may want to check the message first to make sure that it really is spam.',
